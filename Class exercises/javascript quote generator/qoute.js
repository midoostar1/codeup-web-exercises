...
var randomQuotes= [{"quote": "Life isn’t about getting and having, it’s about giving and being.", author: "Kevin Kruse"},
...
btn.addEventListener("click",function (){
    var random = Math.floor(Math.random()*randomQuotes.length)
    quote.innerText = randomQuotes[random].quote
    author.innerText = randomQuotes[random].author
})