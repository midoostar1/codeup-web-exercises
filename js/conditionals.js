 ...
 */
 ...
 function analyzeColor(color) {
    if (color === "red") {
        return "red represents love"

    } else if (color === "orange") {
        return "pawpaws are orange in color "
    } else if (color === "yellow") {
        return "yellow is a beautiful color"
    } else if (color === "green") {
        return "green represents nature"
    } else if (color === "blue") {
        return "blue represents water"
    } else {
        return "i dont know much about " + color }
}
var colorType = analyzeColor("red")
 ...
 */
var inputColor = prompt("input color")
...
var bill = prompt("inout your total bill")
alert("your lucky number was " +luckyNumber +", your price before discount was "+ bill +" and your discounted price is "+ (bill-calculateTotal(bill, luckyNumber)))
/**
 * TODO:
